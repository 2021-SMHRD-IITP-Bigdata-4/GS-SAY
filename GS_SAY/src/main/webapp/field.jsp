...
<head>
    ...
    <style>
        ...
        #region{
            position: absolute; top: 26%; margin-left: 53.8%; margin-right: 0%;
        }
        #field{
            position: absolute; top: 26%; margin-left: 63.2%; margin-right: 0%;
        }
        #target{
    ...
    <div>
        ...
        <div id="tegbox3">
            <div id= "tegbox4">
                <div id = "endbar"> 
                     <div id = "start">
                        <span class="title"><strong>지역별 제도 안내</strong></span>
                    </div>
                </div> 
            </div>
        </div>
        <form action="">
        <div id = "region">
            <select name="region" style="width: 170px; height: 40px; font-size: 100%;">
