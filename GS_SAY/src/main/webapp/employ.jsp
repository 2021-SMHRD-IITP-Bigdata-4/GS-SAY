            ...
            <div id= "tegbox2">
                <table id="menutable" style="text-align: center;">
                    <tr style="background-color:#298AFF;">
                        ...
                        <th id="menutable" style="width:20%; font-size: 100%; height: 50%; color: white; background-color: #FF853F;"><a href="employ.jsp" class="menufont">고용 / 창업</a></th>
