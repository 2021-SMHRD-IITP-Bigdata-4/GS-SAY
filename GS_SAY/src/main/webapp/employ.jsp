    ...
    <div>
            ...
            <div id= "tegbox2">
                <table id="menutable" style="text-align: center;">
                    <tr style="background-color:#298AFF;">
                        ...
                        <th id="menutable" style="width:16.6%; font-size: 100%; height: 50%; color: white; background-color: #FF853F;"><a href="employ.jsp" class="menufont">고용 / 창업</a></th>
        ...
        <div id="tegbox3">
            <div id= "tegbox4">
                <div id = "endbar"> 
                     <div id = "start">
                        <span class="title"><strong>고용 / 창업 제도 안내</strong></span>
                    </div>
                </div> 
            </div>
        </div>
