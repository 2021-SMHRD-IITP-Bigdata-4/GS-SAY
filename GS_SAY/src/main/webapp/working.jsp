    ...
    <div>
            ...
            <div id= "tegbox2">
                <table id="menutable" style="text-align: center;">
                    <tr style="background-color:#298AFF;">
                        ...
                        <th id="menutable" style="width:14%; font-size: 90%; height: 50%; color: white; background-color: #FF853F;"><a href="working.jsp" class="menufont">재직자</a></th>
        ...
        <div id="tegbox3">
            <div id= "tegbox4">
                <div id = "endbar"> 
                     <div id = "start">
                        <span class="title"><strong>재직자 제도 안내</strong></span>
                    </div>
                </div> 
            </div>
        </div>
