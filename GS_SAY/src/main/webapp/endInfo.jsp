...
<head>
    ...
    <style>
        ...
        #hot{
             width: 17%; position: absolute; margin-top: 0.4%; margin-left: 13.5%; margin-right: 15%; width:18%; height: 15%; font-size: 60%;
        }
        #field{
        ...
        <thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><%= endDateMore.get(i).getStartDay() %></td>
              <td><%= endDateMore.get(i).getEndDay() %></td>
